...
with app.app_context():
    # Skip database cleanup for now to avoid lock conflicts
    # TODO: Implement proper database cleanup when not in use
    log.info("Skipping database cleanup to avoid lock conflicts")
